    ...
    return (
        <div className="p-4 font-light space-y-4 text-black h-full min-h-full">
            <div className="bg-gradient-to-r from-indigo-300 to-indigo-600 bg-clip-text">
                <h1 className="text-center text-4xl font-bold text-transparent">
                    NuzStore
                </h1>
            </div>
            <div className="space-y-4">
                ...
                <ul className="space-y-2 italic text-gray-200">
                    ...
                    <li>
                        <Link
                            className="p-2 rounded bg-gray-600 text-indigo-400 flex flex-row items-center"
                            href="./"
                        >
                            <AiFillPushpin />
                            Folder1
            ...
            <div className="space-y-4">
                ...
                <ul className="space-y-2 text-gray-200">
                    <li className="p-2 space-x-2 flex flex-row items-center">
                        <AiOutlineUser />
                        <h3>Account</h3>
                    </li>
                    <li className="p-2 space-x-2 flex flex-row items-center">
                    ...
                    <li className="p-2 space-x-2 text-red-400 flex flex-row items-center">
                        <AiOutlineLogout />
                        <h3>Log out</h3>
                    </li>
                </ul>
